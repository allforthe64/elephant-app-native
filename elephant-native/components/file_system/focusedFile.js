import { View, Text, Modal, TouchableOpacity, Pressable, TextInput, ScrollView, Dimensions} from 'react-native'
import { FontAwesomeIcon } from '@fortawesome/react-native-fontawesome'
import { faXmark, faFile, faFolder, faArrowUpRightFromSquare } from '@fortawesome/free-solid-svg-icons'
                                    ...
                                    {(file.fileName.split('.')[1] !== 'jpg' && file.fileName.split('.')[1] !== 'png') ? 
                                        <View style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', marginTop: '10%'}}>
                                            <View style={{width: '70%',
                                                    ...
                                                    >
                                                        <Text style={{fontSize: 20, color: 'black', fontWeight: '600'}}>View File In Browser</Text>
                                                        <FontAwesomeIcon icon={faArrowUpRightFromSquare} size={20} style={{marginTop: '1%'}}/>
                                                    </TouchableOpacity>
                                            </View>
                                        </View>
                                    : <></>}
